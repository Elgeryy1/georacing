# Actualización de Beacons con Métricas del Sistema

Las beacons ahora deben reportar métricas adicionales del sistema cuando envíen el heartbeat.
...
## Actualización del Cliente Beacon
