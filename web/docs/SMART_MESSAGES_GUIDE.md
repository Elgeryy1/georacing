...
El sistema de mensajes inteligentes genera **automáticamente textos apropiados** para las beacons cuando no se especifica un mensaje personalizado. Los textos varían según:
...
**P: ¿Las beacons WPF usan los mismos textos?**
